...
function loadCart() {
    try {
        const d = localStorage.getItem('web_cart');
...
function saveOrders() {
    try {
        localStorage.setItem('web_orders', JSON.stringify(orders));
    } catch (_) {}
}

function loadOrders() {
    try {
        const d = localStorage.getItem('web_orders');
    ...
    container.innerHTML = `
        ...
        <div class="stats">
            <div class="stat">
                ...
                <strong>200+</strong>
                <small>Branches Nationwide</small>
            </div>
            <div class="stat">
                <i class="fas fa-star"></i>
                <strong>5★</strong>
        ...
        <h3 class="section-title" style="margin-top: 24px;">💬 Customer Reviews</h3>
        ...
        <div class="about-snippet">
            ...
            <p style="font-size:14px;color:var(--text-tertiary);margin-top:4px;">📍 Goodyear Court 6, Persiaran Mulia, USJ 8</p>
            <div class="tags">
        ...
        <div style="background:var(--card);border-radius:var(--radius);padding:20px 24px;box-shadow:var(--shadow-sm);margin-bottom:16px;border:1px solid var(--separator);">
            <div style="display:flex;flex-wrap:wrap;gap:12px;align-items:center;justify-content:space-between;">
                <div style="display:flex;align-items:center;gap:14px;">
                    <span style="font-size:32px;">✅</span>
                    <div>
                        <div style="font-weight:700;font-size:16px;color:var(--text);">JAKIM Halal &amp; MeSTI Certified</div>
                        <div style="font-size:14px;color:var(--text-tertiary);">Product &amp; premises certified</div>
                    </div>
                </div>
                <button onclick="switchTab('profile')" 
                        style="font-size:14px;font-weight:600;color:var(--primary);background:none;border:none;cursor:pointer;font-family:inherit;padding:6px 0;">
                    Learn more →
                </button>
            </div>
        </div>
...
function renderMenu() {
    ...
    container.innerHTML = `
        ...
        <div class="menu-grid" id="menuGrid">
            ${items.length > 0 ? itemsHTML : '<div style="grid-column:1/-1;text-align:center;padding:60px 0;color:var(--text-tertiary);font-size:18px;">No items in this category</div>'}
        </div>
    `;
...
function renderCart() {
    ...
    cartHTML += `
            ...
            <div class="cart-summary">
                ...
                <div class="row total">
                    <span>Total</span>
                    <span class="amount">${fmt(getCartTotal())}</span>
                </div>
...
function renderProfile() {
    ...
    container.innerHTML = `
        <div class="profile-grid">
            ...
            <div class="profile-notice" style="border-left-color: #f59e0b;">
                <p><i class="fas fa-triangle-exclamation" style="color:#f59e0b;"></i> <strong>Notice:</strong> We are an independent establishment at Goodyear Court 6, USJ 8. Not affiliated with Restoran Pak Ali in USJ 9.</p>
            </div>
        </div>
    `;
}
...
function switchTab(tabId) {
    ...
    // Update tab buttons
    document.querySelectorAll('.web-nav button').forEach(btn => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Log
    console.log('🖥️ Web Interface loaded');
